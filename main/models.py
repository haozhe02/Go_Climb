...
class Account(models.Model):
    ...
    emergencyContact = models.EmailField(null=True, blank=True)
    emergencyContactName = models.CharField(max_length=150, null=True, blank=True)

    tracking = models.BooleanField(default=False)
    lastCoorDate = models.TextField(null=True, blank=True)
    lastCoor = models.CharField(null=True, blank=True)
